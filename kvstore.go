...
func newKVStore(snapshotter *raftsnap.Snapshotter, confChangeC chan<- raftpb.ConfChange, proposeC chan<- string, commitC <-chan *string, errorC <-chan error) *kvstore {
	s := &kvstore{
		proposeC:    proposeC,
